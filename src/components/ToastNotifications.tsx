...
export const ToastNotifications: React.FC<ToastNotificationsProps> = ({ currentUser }) => {
  ...
  return (
    <div className="fixed bottom-28 right-5 z-50 flex flex-col gap-3 max-w-[380px] w-full px-4 sm:px-0 pointer-events-none">
      <AnimatePresence>
        {activeToasts.map((toast) => (
          <motion.div
            ...
            className="pointer-events-auto bg-[#141416]/95 border border-[#2A2A2E] rounded-2xl p-4 shadow-2xl backdrop-blur-xl relative overflow-hidden group"
          >
